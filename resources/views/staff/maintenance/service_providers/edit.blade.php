<x-staff-layout>
    ...
    <div class="flex flex-col container mx-4 border border-0 md:mx-auto">
        ...
        <section class="py-8 mt-2">
            <div>
                <form  action="{{ route('staff.maintenance.service_providers.update',['service_provider'=>$service_provider->id]) }} " method="POST" enctype="multipart/form-data" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                    @csrf

                    

                    <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                        <h2 class="font-semibold text-xl py-1" >Edit Service Provider</h2>
                    ...
                    <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] py-3">
                        ...
                        <input type="text" name="provider_name" class="border border-1 border-gray-400 bg-gray-50
                                                                ...
                                                                value="{{ $service_provider->provider_name }}"
                    ...
                    <div class="flex flex-col w-[80%] md:w-[60%] py-3">
                        <select name="provider_type" class="border border-1 border-gray-400 bg-gray-50
                                                                     ...
                                                                     >
                                                                        ...
                                                                        <option value='internal' @if($service_provider->provider_type=='internal') selected @endif >Internal</option>
                                                                        <option value='external' @if($service_provider->provider_type=='external') selected @endif >External</option>
                    ...
                    <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 border-red-900 w-[80%] md:w-[60%] py-3">
                                     ...
                                     <div class="w-full md:w-2/3">
                                                <input type="text" name="contact_person" class="border border-1 border-gray-400 bg-gray-50
                                                                                        ...
                                                                                        value="{{ $service_provider->contact_person }}"
                                    ...
                                    <div class="w-full md:w-1/3">
                                                <input type="text" name="contact_phone" class="border border-1 border-gray-400 bg-gray-50
                                                                                        ...
                                                                                        value="{{ $service_provider->contact_phone }}"
                    ...
                    <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] py-3">
                        ...
                        <input type="text" name="service_categories" class="border border-1 border-gray-400 bg-gray-50
                                                                            ...
                                                                            value="{{ $service_provider->service_categories }}"
                    ...
                    <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                        <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                       hover:bg-gray-500
                                       rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Update Service Provider</button>
                    </div>
