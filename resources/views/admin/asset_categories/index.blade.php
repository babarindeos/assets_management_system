            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    ...
                    <div class="flex flex-row w-3/4 justify-end space-x-1">
                                ...
                                <div class="border-0 flex flex-col items-center justify-center">
                                        <a href="{{ route('admin.asset_categories.create') }}" class="bg-green-600 text-white py-2 px-4 
                                                rounded-lg text-sm hover:bg-green-500">New Category</a>
                                </div>
                                    ...
                                    <td class="text-center">
                                        <span class="text-sm">
                                            <a class="hover:bg-blue-500 bg-blue-400 text-white rounded-md 
                                                    px-4 py-1 text-xs" href="{{ route('admin.asset_categories.edit', ['category'=>$category->id])}}">Edit</a>
                                        </span>
                                        <span> 
                                            <a class="hover:bg-red-500 bg-red-400 text-white rounded-md 
                                                    px-4 py-1 text-xs" href="{{ route('admin.asset_categories.confirm_delete', ['category'=>$category->id])}}"
                                            >Delete</a>
                                        </span>
                                    </td>
                                </tr>
