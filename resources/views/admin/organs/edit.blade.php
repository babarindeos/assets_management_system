    ...
    <div class="container mx-auto">
        ...
        <section class="flex flex-col w-[90%] md:w-[95%] py-8 px-4 border-red-900 mx-auto">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div >
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">Edit Organ</h1>
                    </div>
        ...
        <section class="mb-8">
                <div>
                    <form  action="{{ route('admin.organs.update', ['organ' => $organ->id])}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf
                            ...
                            <select name="location_type" class="border border-1 border-gray-400 bg-gray-50
                                                                    ...
                                                                    <option value=''>-- Select Location Type --</option>
                                                                        @foreach($location_types as $location_type)
                                                                            <option class='py-4' @if ($location_type->id == $organ->location_type_id) selected @endif 
                                                                                    value="{{$location_type->id}}">{{$location_type->name}}</option>
                                                                        @endforeach                                                                    
                                                                    </select>
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                           hover:bg-gray-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Update Organ</button>
                        </div>
