...
class Staff_MaintenanceHistoryController extends Controller
{
    //
    public function index(Request $request)
    {
        ...
        return view('staff.maintenance.history.index')->with(['maintenance_history'=>$history_data, 'isPostBack'=>$isPostBack, 'assets'=>$maintainable_assets]);
    }
}
